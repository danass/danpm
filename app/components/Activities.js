...
export default function Activities() {
  ...
  const { t, activities: activitiesData } = useLanguage()
  ...
  return (
    <section>
      ...
      >
        ...
        <p className="text-sm font-light" dangerouslySetInnerHTML={{ __html: activitiesData.text.replace(/(Ceinture bleue de Jujitsu brésilien|Blue belt in Brazilian Jiu-Jitsu)/g, '<strong class="font-medium text-slate-900">$1</strong>') }} />
        </div>
      </div>
    </section>
  )
