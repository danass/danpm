    ...
    <section>
      ...
      >
        ...
        <p className="text-sm font-light">
          <strong className="font-medium text-slate-900">Français</strong> : Bilingue | <strong className="font-medium text-slate-900">Anglais</strong> : Bilingue | <strong className="font-medium text-slate-900">Espagnol</strong> : Débutant
        </p>
        </div>
      </div>
    </section>
