      ...
      >
        <div className="text-slate-600">
          <p className="text-sm font-light">
            <strong className="font-medium text-slate-900">French</strong>: Bilingual | <strong className="font-medium text-slate-900">English</strong>: Bilingual | <strong className="font-medium text-slate-900">Spanish</strong>: Beginner
          </p>
        </div>
      </div>
    </section>
