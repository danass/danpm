export const translations = {
  fr: {
    ...
    profile: {
      title: "Profil",
      description: "Product Manager spécialisé dans la modernisation de systèmes legacy et l'optimisation produit. Expert en rédaction de spécifications détaillées, accompagnement d'équipes techniques, conception de fonctionnalités data-driven, et prise en compte des besoins utilisateurs et objectifs business."
    },
    experience: {
      title: "Expérience",
      present: "Présent",
    ...
    skills: {
      ...
      categories: {
        ...
        transversal: "Compétences Transverses"
      }
    },
    aboutCV: {
      madeWith: "Mis en forme avec"
    },
    education: {
      title: "Formation",
      additional: "Formation Complémentaire",
      data: [
        {
    ...
    languages: {
      title: "Langues",
      text: "Français : Bilingue | Anglais : Bilingue | Espagnol : Débutant | Permis B"
    },
    activities: {
      title: "Activités",
      text: "Pratiques artistiques : Photographie | Ceinture bleue de Jujitsu brésilien"
    }
  },
  en: {
    header: {
    ...
    profile: {
      title: "Profile",
      description: "Product Manager specialized in legacy system modernization and product optimization. Expert in detailed specification writing, technical team support, data-driven feature design, and consideration of user needs and business objectives."
    },
    experience: {
      title: "Experience",
      present: "Present",
    ...
    education: {
      ...
      additional: [
        ...
        {
          degree: "Bachelor's in Modern Literature",
          institution: "Sorbonne",
          period: "2005 - 2008",
          details: ""
        },
    ...
    languages: {
      title: "Languages",
      text: "French: Bilingual | English: Bilingual | Spanish: Beginner | Driver's License (Category B)"
    },
    activities: {
      title: "Activities",
      text: "Artistic practices: Photography | Blue belt in Brazilian Jiu-Jitsu"
    }
  }
}
...
// Ajouter les autres données (skills, education, etc.) ici
